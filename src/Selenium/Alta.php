...
class Alta extends Operation
{
    ...
    public function doOperation()
    {
        ...
        */
         ...
         */
        $this->driver->findElement(WebDriverBy::name('txt_SDFFREALDD'))->sendKeys($this->operation->getFra()->format("d"));
        $this->driver->findElement(WebDriverBy::name('txt_SDFFREALMM'))->sendKeys($this->operation->getFra()->format("m"));
        $this->driver->findElement(WebDriverBy::name('txt_SDFFREALAA'))->sendKeys($this->operation->getFra()->format("Y"));
         ...
         * Tres dígitos INT.
         */
        $this->driver->findElement(WebDriverBy::name('txt_SDFTICO_ayuda'))->sendKeys($this->operation->getTco()->getCkey());
